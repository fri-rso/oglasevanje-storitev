...
/**
 * <p>JPA class representing the Advert entity and table in the database.</p>
 *
 * @author Tilen Faganel
 * @since 2.0.0
 */
@Entity
@NamedQuery(name="Advert.findAll", query="SELECT title FROM adverts")
public class Advert {
     ...
     * <p>Sets the orders.</p>
     *
     * <p>You can use getBookOrders() to get the value of orders.</p>
     */
    public void setBookOrders(List<Order> orders) {
